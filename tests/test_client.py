...
from jenna_stream_orders import JennaStreamOrders, AsyncJennaStreamOrders, APIResponseValidationError
from jenna_stream_orders._types import Omit
from jenna_stream_orders._utils import asyncify
from jenna_stream_orders._models import BaseModel, FinalRequestOptions
from jenna_stream_orders._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from jenna_stream_orders._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: JennaStreamOrders | AsyncJennaStreamOrders) -> int:
...
class TestJennaStreamOrders:
    @pytest.mark.respx(base_url=base_url)
    def test_raw_response(self, respx_mock: MockRouter, client: JennaStreamOrders) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_raw_response_for_binary(self, respx_mock: MockRouter, client: JennaStreamOrders) -> None:
    ...
    def test_copy(self, client: JennaStreamOrders) -> None:
        copied = client.copy()
    ...
    def test_copy_signature(self, client: JennaStreamOrders) -> None:
    ...
    def test_copy_build_request(self, client: JennaStreamOrders) -> None:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "jenna_stream_orders/_legacy_response.py",
                        "jenna_stream_orders/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "jenna_stream_orders/_compat.py",
    ...
    def test_request_timeout(self, client: JennaStreamOrders) -> None:
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
    ...
    def test_hardcoded_query_params_in_url(self, client: JennaStreamOrders) -> None:
    ...
    def test_request_extra_json(self, client: JennaStreamOrders) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_headers(self, client: JennaStreamOrders) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_query(self, client: JennaStreamOrders) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_multipart_repeating_array(self, client: JennaStreamOrders) -> None:
        request = client._build_request(
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload(self, respx_mock: MockRouter, client: JennaStreamOrders) -> None:
    ...
    def test_binary_content_upload_with_body_is_deprecated(
        self, respx_mock: MockRouter, client: JennaStreamOrders
    ) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_basic_union_response(self, respx_mock: MockRouter, client: JennaStreamOrders) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_union_response_different_types(self, respx_mock: MockRouter, client: JennaStreamOrders) -> None:
    ...
    def test_base_url_trailing_slash(self, client: JennaStreamOrders) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: JennaStreamOrders) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: JennaStreamOrders) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_client_response_validation_error(self, respx_mock: MockRouter, client: JennaStreamOrders) -> None:
        class Model(BaseModel):
            foo: str
    ...
    def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, client: JennaStreamOrders
    ) -> None:
    ...
    @mock.patch("jenna_stream_orders._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: JennaStreamOrders) -> None:
        respx_mock.get("/stream-dsp/v1/authorize").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            client.stream_dsp.v1.with_streaming_response.authorize(
    ...
    @mock.patch("jenna_stream_orders._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: JennaStreamOrders) -> None:
        respx_mock.get("/stream-dsp/v1/authorize").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.get("/stream-dsp/v1/authorize").mock(side_effect=retry_handler)
    ...
    def test_omit_retry_count_header(
        self, client: JennaStreamOrders, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects(self, respx_mock: MockRouter, client: JennaStreamOrders) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects_disabled(self, respx_mock: MockRouter, client: JennaStreamOrders) -> None:
...
class TestAsyncJennaStreamOrders:
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response(self, respx_mock: MockRouter, async_client: AsyncJennaStreamOrders) -> None:
        respx_mock.post("/foo").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response_for_binary(self, respx_mock: MockRouter, async_client: AsyncJennaStreamOrders) -> None:
        respx_mock.post("/foo").mock(
            return_value=httpx.Response(200, headers={"Content-Type": "application/binary"}, content='{"foo": "bar"}')
        )
    ...
    def test_copy(self, async_client: AsyncJennaStreamOrders) -> None:
    ...
    def test_copy_signature(self, async_client: AsyncJennaStreamOrders) -> None:
        # ensure the same parameters that can be passed to the client are defined in the `.copy()` method
        init_signature = inspect.signature(
            # mypy doesn't like that we access the `__init__` property.
    ...
    @pytest.mark.skipif(sys.version_info >= (3, 10), reason="fails because of a memory leak that started from 3.12")
    def test_copy_build_request(self, async_client: AsyncJennaStreamOrders) -> None:
        options = FinalRequestOptions(method="get", url="/foo")
    ...
    async def test_request_timeout(self, async_client: AsyncJennaStreamOrders) -> None:
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncJennaStreamOrders) -> None:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncJennaStreamOrders) -> None:
        request = async_client._build_request(
            FinalRequestOptions.construct(
                method="post",
                url="/foo",
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_binary_content_upload(self, respx_mock: MockRouter, async_client: AsyncJennaStreamOrders) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    async def test_binary_content_upload_with_body_is_deprecated(
        self, respx_mock: MockRouter, async_client: AsyncJennaStreamOrders
    ) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_basic_union_response(self, respx_mock: MockRouter, async_client: AsyncJennaStreamOrders) -> None:
        class Model1(BaseModel):
            name: str
    ...
    async def test_base_url_trailing_slash(self, client: AsyncJennaStreamOrders) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_base_url_no_trailing_slash(self, client: AsyncJennaStreamOrders) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_absolute_request_url(self, client: AsyncJennaStreamOrders) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, async_client: AsyncJennaStreamOrders
    ) -> None:
        headers = httpx.Headers({"retry-after": retry_after})
        options = FinalRequestOptions(method="get", url="/foo", max_retries=3)
    ...
    async def test_retrying_timeout_errors_doesnt_leak(
        ...
        with pytest.raises(APITimeoutError):
            await async_client.stream_dsp.v1.with_streaming_response.authorize(
                client_id="client_id", redirect_uri="redirect_uri", response_type="code"
            ).__aenter__()
    ...
    async def test_retries_taken(
        self,
        async_client: AsyncJennaStreamOrders,
        failures_before_success: int,
        failure_mode: Literal["status", "exception"],
        respx_mock: MockRouter,
    ) -> None:
        ...
        response = await client.stream_dsp.v1.with_raw_response.authorize(
            client_id="client_id", redirect_uri="redirect_uri", response_type="code"
        )
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncJennaStreamOrders, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_follow_redirects(self, respx_mock: MockRouter, async_client: AsyncJennaStreamOrders) -> None:
        # Test that the default follow_redirects=True allows following redirects
        respx_mock.post("/redirect").mock(
            return_value=httpx.Response(302, headers={"Location": f"{base_url}/redirected"})
        )
